...
public class SampleDataCommandLineRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Job job1 = new Job(1, "IT", "Software Engineer", "Junior", "XYZ Company", "We are seeking...", 1L,
                50000, 80000, new Timestamp(new SimpleDateFormat("yyyy-MM-dd").parse("2023-09-01").getTime()), Date.valueOf("2023-12-31"), "jobs@xyzcompany.com", "(123) 456-7890", 1);
        jobRepository.save(job1);
        Job job2 = new Job(2, "Marketing", "Content Writer", "Entry-level", "ABC Inc.", "We are looking for...", 2L,
                40000, 60000, new Timestamp(new SimpleDateFormat("yyyy-MM-dd").parse("2023-09-01").getTime()), Date.valueOf("2023-12-31"), "jobs@abcinc.com", "(123) 456-7890", 2);
        jobRepository.save(job2);
        Job job3 = new Job(3, "IT", "Web Developer", "Senior", "DEF Company", "", 3L,
                80000, 120000, new Timestamp(new SimpleDateFormat("yyyy-MM-dd").parse("2023-09-01").getTime()), Date.valueOf("2023-12-25"), "jobs@defcompany.com", "(123) 456-7890", 1);
        jobRepository.save(job3);

        // Creating and saving social media types
        ...
        // Creating and saving social media profiles
        ...
        // Creating and saving CVs
        CV cv = new CV(1L, "/path/to/cv.pdf", 1L);
        cvRepository.save(cv);
        CV cv2 = new CV(2L, "/path/to/cv-janedoe.pdf", 2L);
        cvRepository.save(cv2);

        // Creating and saving jobRqm
        JobRequirements jobReq1 = new JobRequirements(1, "Strong coding skills in Java and Python", 1);
        jobRequirementsRepository.save(jobReq1);
        JobRequirements jobReq2 = new JobRequirements(2, "Excellent communication skills", 2);
